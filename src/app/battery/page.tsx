      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-3 sm:px-6 lg:px-8 py-4 sm:py-6 space-y-6">
        <div>
          <h1 className="font-heading text-xl sm:text-2xl font-bold text-foreground flex items-center space-x-2.5">
            <Battery className="h-6 w-6 text-amber-400 flex-shrink-0" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
          <div className="hud-card p-4 sm:p-5 space-y-3">
            <div className="flex items-center space-x-2.5">
              <div className="p-2 rounded-lg bg-accent/15 text-accent border border-accent/30 flex-shrink-0">
            ...
            <div className="space-y-2 text-xs font-mono text-foreground bg-background/90 p-3 sm:p-3.5 rounded-lg border border-border">
              <div className="flex justify-between">
                <span className="text-muted-foreground">Consumo en reposo:</span>
                <span className="text-hud-success font-bold">~0.15 mA</span>
              </div>
              <div className="flex justify-between">
                <span className="text-muted-foreground">Consumo en reporte:</span>
                <span className="text-amber-400 font-bold">~120 mA (4s)</span>
              </div>
              <div className="flex justify-between">
                <span className="text-muted-foreground">Consumo diario (3 envíos):</span>
          ...
          <div className="hud-card p-4 sm:p-5 space-y-3">
            <div className="flex items-center space-x-2.5">
              <div className="p-2 rounded-lg bg-amber-500/15 text-amber-400 border border-amber-500/30 flex-shrink-0">
            ...
            <div className="p-3 sm:p-3.5 bg-background/90 rounded-lg border border-border text-[10px] sm:text-[11px] text-muted-foreground font-mono leading-relaxed overflow-x-auto">
